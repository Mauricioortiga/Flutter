...
**Quando marcado com a "?", estamos sinalizando para o dart que aquela variável é "nullable"**, e ele deixará que você crie a variável sem um valor padrão. Porém, ao tentar utilizar essas variáveis, você poderá deparar-se com o erro **"The argument type can't be assigned to the parameter type"**. 

Isso acontece porque, ao utilizar-se da interrogação, é necessário que você também marque o uso dessa variável marcada. Ou seja, quando você for utilizar as variáveis marcadas você precisa fazer uma de duas coisas:
...
Basicamente, é assim que lidamos com a questão do NullSafety.
